...
"[project]/app/billing/payments/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const methodConfig = {
    cash: {
        ...
        icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$banknote$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Banknote$3e$__["Banknote"], {
            ...
            fileName: "[project]/app/billing/payments/page.tsx",
            lineNumber: 18,
            columnNumber: 36
...
function PaymentsPage() {
    ...
    const filteredPayments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PaymentsPage.useMemo[filteredPayments]": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["payments"].filter({
                "PaymentsPage.useMemo[filteredPayments]": (pay)=>{
                    const invoice = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoices"].find({
                        "PaymentsPage.useMemo[filteredPayments].invoice": (i)=>i.id === pay.invoiceId
                    }["PaymentsPage.useMemo[filteredPayments].invoice"]);
                    const patient = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["patients"].find({
                        "PaymentsPage.useMemo[filteredPayments].patient": (p)=>p.id === invoice?.patientId
                    }["PaymentsPage.useMemo[filteredPayments].patient"]);
                    const matchesSearch = pay.receiptNumber.toLowerCase().includes(search.toLowerCase()) || patient?.name.toLowerCase().includes(search.toLowerCase());
                    const matchesMethod = methodFilter === "all" || pay.method === methodFilter;
                    return matchesSearch && matchesMethod;
                }
            }["PaymentsPage.useMemo[filteredPayments]"]).sort({
                "PaymentsPage.useMemo[filteredPayments]": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
            }["PaymentsPage.useMemo[filteredPayments]"]);
        }
    }["PaymentsPage.useMemo[filteredPayments]"], [
        search,
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PaymentsPage.useMemo[stats]": ()=>{
            const today = new Date().toDateString();
            const todayPayments = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["payments"].filter({
                "PaymentsPage.useMemo[stats].todayPayments": (p)=>new Date(p.date).toDateString() === today
            }["PaymentsPage.useMemo[stats].todayPayments"]);
            const todayTotal = todayPayments.reduce({
                "PaymentsPage.useMemo[stats].todayTotal": (acc, p)=>acc + p.amount
            }["PaymentsPage.useMemo[stats].todayTotal"], 0);
            const monthTotal = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["payments"].reduce({
                "PaymentsPage.useMemo[stats].monthTotal": (acc, p)=>acc + p.amount
            }["PaymentsPage.useMemo[stats].monthTotal"], 0);
            return {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-muted-foreground",
                                    children: "Registro de pagos y cobros"
                                }, void 0, false, {
                                    fileName: "[project]/app/billing/payments/page.tsx",
                                    lineNumber: 57,
                                    columnNumber: 13
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PaymentForm, {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    filteredPayments.map((pay)=>{
                                        const invoice = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoices"].find((i)=>i.id === pay.invoiceId);
                                    ...
                                    filteredPayments.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "py-12 text-center text-muted-foreground",
                                        children: "No se encontraron pagos"
                                    }, void 0, false, {
                                        fileName: "[project]/app/billing/payments/page.tsx",
                                        lineNumber: 172,
                                        columnNumber: 17
...
_s(PaymentsPage, "bdV28Yr1h1XRvCOBiq1yXNbyMxU=");
_c = PaymentsPage;
function PaymentForm({ onClose }) {
    ...
    const pendingInvoices = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoices"].filter((i)=>i.status === "pending" || i.status === "partial");
...
_s1(PaymentForm, "kvPiDdvQhDgHRjBlDRhsDq/monI=");
_c1 = PaymentForm;
var _c, _c1;
__turbopack_context__.k.register(_c, "PaymentsPage");
__turbopack_context__.k.register(_c1, "PaymentForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_c5394f67._.js.map